...
export default function PlaygroundPage() {
    ...
    return (
        <div className="min-h-screen bg-[#fcfcfd] text-neutral-800 selection:bg-emerald-500/30 font-sans overflow-x-hidden">
            {/* Background Decor */}
            <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
                <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-emerald-500/[0.03] blur-[100px] rounded-full" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-blue-500/[0.03] blur-[100px] rounded-full" />
            </div>
            ...
            <main className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 pb-20">
                ...
                <header className="mb-8 space-y-3">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-emerald-50/50 px-4 py-1.5 text-[10px] font-black text-emerald-700 uppercase tracking-widest mb-4">
                        ...
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tighter text-neutral-900 leading-tight mb-4">
                            Developer
                            <span className="text-emerald-500 italic"> Playground</span>.
                        </h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-4 sm:gap-6 items-start">
                    ...
                    <section className="space-y-6 flex flex-col h-full">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 bg-emerald-500 text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-500/20 w-fit">
                                <Terminal className="w-3 h-3" /> Real-time Execution Demo
                            </div>
                            <Link href="/admin" target="_blank" className="group flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500 hover:text-emerald-600 transition-colors">
